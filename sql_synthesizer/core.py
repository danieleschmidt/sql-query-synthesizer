...
class ErrorHandler:
    ...
    def format_llm_error(error: Exception) -> str:
        ...
        if 'timeout' in error_msg:
            ...
            return "Query generation service error. Falling back to basic SQL generation."
...
def create_query_metadata(query_id: str, duration_ms: float, cache_hit: bool = False,
                         user_agent: Optional[str] = None, client_ip: Optional[str] = None) -> QueryMetadata:
