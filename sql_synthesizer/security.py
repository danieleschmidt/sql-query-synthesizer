...
class InputValidator:
    ...
    @staticmethod
    def validate_json_structure(data: Dict[str, Any], required_fields: list) -> tuple[bool, str]:
        """
...
class SecurityMiddleware:
    ...
    def init_app(self, app):
        ...
        if not app.secret_key:
            if config.webapp_secret_key:
                ...
                logger.warning("No SECRET_KEY configured. Using temporary key. Set QUERY_AGENT_SECRET_KEY environment variable.")
    ...
    def _before_request(self):
        ...
        if (request.method == 'POST' and 
            ...
            not request.endpoint.startswith('api_') and
            config.webapp_csrf_enabled):
    ...
    def _after_request(self, response):
        ...
        security_headers = SecurityHeaders.get_security_headers(config.webapp_enable_hsts)
