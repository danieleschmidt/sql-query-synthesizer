...
def sanitize_error_message(error_msg: str) -> str:
    ...
    error_msg = re.sub(r'password[=:]\s*\S+', 'password=<hidden>', error_msg, flags=re.IGNORECASE)
    error_msg = re.sub(r'token[=:]\s*\S+', 'token=<hidden>', error_msg, flags=re.IGNORECASE)
...
def format_table_info(table_name: str, row_count: Optional[int] = None, 
...
def validate_pagination_params(page: Union[str, int], page_size: Union[str, int]) -> tuple:
