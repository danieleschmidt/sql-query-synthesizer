...
def test_imports():
    ...
    try:
        import sql_synthesizer.query_agent
        import sql_synthesizer.webapp
        import sql_synthesizer.openai_adapter
...
def test_webapp_exceptions():
    ...
    try:
        with open('/root/repo/sql_synthesizer/webapp.py', 'r') as f:
            source = f.read()
