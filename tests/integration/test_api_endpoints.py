...
class TestQueryAPI:
    ...
    def test_query_endpoint_structure(self):
        ...
        expected_request = {"question": "Show me the first 10 users", "max_rows": 10}
    ...
    def test_query_request_validation(self):
        ...
        # Valid request
        valid_request = {"question": "Show me all users", "max_rows": 100}
        ...
        for invalid_req in invalid_requests:
            ...
            if not invalid_req.get("question"):
                ...
                invalid_req.get("max_rows", 10) <= 0
                or invalid_req.get("max_rows", 10) > 1000
            ):
...
class TestHealthAPI:
    ...
    def test_health_response_structure(self):
        ...
        expected_health_response = {
            ...
            "cache": {"healthy": True, "hit_rate": 85.5, "size": 150},
            "llm": {"healthy": True, "provider": "openai", "model": "gpt-3.5-turbo"},
        }
    ...
    def test_health_status_values(self):
        ...
        component_health_map = {True: "healthy", False: "unhealthy"}
...
class TestAPIValidation:
    ...
    def test_content_type_validation(self):
        ...
        valid_content_types = ["application/json", "application/json; charset=utf-8"]
    ...
    def test_sql_injection_prevention(self):
        ...
        for malicious_input in malicious_inputs:
            ...
            assert any(
                ...
                for keyword in ["DROP", "UNION", "INSERT", "DELETE"]
            )
...
class TestAPIPerformance:
    ...
    def test_concurrent_request_handling(self):
        ...
        assert (
            concurrency_targets["connection_pool_size"]
            <= concurrency_targets["max_concurrent_users"]
        )
