...
class TestOpenAIAdapterInterface:
    ...
    def test_openai_adapter_timeout_error(self, mock_openai):
        ...
        mock_openai.chat.completions.create.side_effect = MockTimeout("Request timed out")
    ...
    def test_openai_adapter_auth_error(self, mock_openai):
        ...
        mock_openai.chat.completions.create.side_effect = MockAuthenticationError("Invalid API key")
