...
class TestQueryService:
    ...
    def test_query_with_cache_hit(self):
        ...
        # Setup mocks
        cached_result = QueryResult(sql="SELECT * FROM users", data=[{"id": 1, "name": "John"}])
    ...
    def test_query_with_cache_miss(self):
        ...
        self.mock_engine.connect.return_value.__enter__ = Mock(return_value=mock_connection)
    ...
    def test_discover_schema_cache_miss(self):
        ...
        self.mock_schema_cache.set.assert_called_once_with("tables", ["users", "orders"])

    def test_get_cache_stats(self):
        """Test cache statistics retrieval."""
        schema_stats = {"hit_count": 10, "miss_count": 2, "size": 5, "hit_rate": 0.8, "total_operations": 12}
        query_stats = {"hit_count": 20, "miss_count": 3, "size": 8, "hit_rate": 0.87, "total_operations": 23}
