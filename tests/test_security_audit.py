...
class TestSecurityAuditLogger:
    ...
    def test_log_basic_event(self):
        ...
        assert self.audit_logger._event_counts[SecurityEventType.UNSAFE_INPUT_DETECTED] == 1
    ...
    def test_log_rate_limit_exceeded(self):
        ...
        assert "Rate limit exceeded: requests_per_minute - 150/100" in log_data["message"]
    ...
    def test_log_query_execution(self):
        ...
        sql_query = "SELECT id, name FROM users WHERE status = 'active' ORDER BY name LIMIT 10"
    ...
    def test_log_query_execution_with_long_query(self):
        ...
        long_query = "SELECT " + ", ".join([f"column_{i}" for i in range(100)]) + " FROM users"
