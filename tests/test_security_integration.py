...
from sql_synthesizer.security import InputValidator, RateLimiter, SecurityMiddleware
...
class TestSecurityIntegration:
    ...
    def test_error_message_sanitization(self, client, test_agent):
        ...
        # Mock an error
        test_agent.query.side_effect = Exception(
            "Internal database connection failed at /root/sensitive/path"
        )
        ...
        assert (
            "error occurred" in error_message.lower()
            or "connection issue" in error_message.lower()
        )
...
class TestSecurityMiddleware:
    ...
    def test_input_validator(self):
        ...
        valid, msg = validator.validate_json_structure(
